...
#define BALLRES0 (SIGRTMIN+3)
#define BALLRES1 (SIGRTMIN+4)
#define BALLRES2 (SIGRTMIN+5)
#define BALLRES3 (SIGRTMIN+6)
#define BALLRES4 (SIGRTMIN+7)
#define BALLRES5 (SIGRTMIN+8)
#define BALLRES6 (SIGRTMIN+9)
#define BALLRES7 (SIGRTMIN+10)
#define OUT (SIGRTMIN+10)
